...
namespace pleaseoftheloveofgodbethelastversionofthisproject.Pages.Home
{
    public class LeaderboardsModel : PageModel
    {
        ...
        public static int? ListInputStatic;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            UserList = await _db.AspNetUsers.FromSqlRaw("SELECT * FROM [dbo].[AspNetUsers] ORDER BY " + (tempUserInput ?? "CorrectAnswers") + " DESC").ToListAsync();
